...
def evaluate_model(trainX, trainy, testX, testy):
	...
	selected_model = Models(model_type, n_timesteps, n_features, n_outputs, n_steps, n_length)
	selected_model.model.fit(trainX, trainy, epochs=epochs, batch_size=batch_size, verbose=verbose)
	_, accuracy = selected_model.model.evaluate(testX, testy, batch_size=batch_size, verbose=verbose)
